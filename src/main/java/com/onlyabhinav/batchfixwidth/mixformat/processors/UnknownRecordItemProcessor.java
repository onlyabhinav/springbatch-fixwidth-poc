 ...
 */
package com.onlyabhinav.batchfixwidth.mixformat.processors;
...
public class UnknownRecordItemProcessor implements ItemProcessor<UnknownRecord, UnknownRecord> {

	@Override
	public UnknownRecord process(UnknownRecord item) throws Exception {
		return item;
	}
}
